...
func Init() {
	...
	handler.RegisterRpc2[pb.LoginReq, pb.LoginRsp](framework.PROTO, pb.NodeType_Gate, pb.CMD_CMD_EMPTY, "PlayerMgr.LoginSuccess") // 登录成功
	handler.RegisterRpc2[pb.HeartReq, pb.HeartRsp](framework.PROTO, pb.NodeType_Gate, pb.CMD_HEART_REQ, "Player.Heart")           // 心跳请求
}
